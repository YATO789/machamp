...
const _predefinedExercises = <Exercise>[
  ...
  Exercise(id: 'incline_press', name: 'インクラインプレス', bodyPart: '胸', equipment: 'ダンベル'),
  ...
  Exercise(id: 'lat_pulldown', name: 'ラットプルダウン', bodyPart: '背中', equipment: 'マシン'),
  ...
  Exercise(id: 'lateral_raise', name: 'サイドレイズ', bodyPart: '肩', equipment: 'ダンベル'),
  Exercise(id: 'front_raise', name: 'フロントレイズ', bodyPart: '肩', equipment: 'ダンベル'),
  Exercise(id: 'face_pull', name: 'フェイスプル', bodyPart: '肩', equipment: 'ケーブル'),
  Exercise(id: 'bicep_curl', name: 'バイセップカール', bodyPart: '腕', equipment: 'ダンベル'),
  Exercise(id: 'hammer_curl', name: 'ハンマーカール', bodyPart: '腕', equipment: 'ダンベル'),
  Exercise(id: 'tricep_ext', name: 'トライセップエクステンション', bodyPart: '腕', equipment: 'ケーブル'),
  Exercise(id: 'tricep_pushdown', name: 'トライセッププッシュダウン', bodyPart: '腕', equipment: 'ケーブル'),
